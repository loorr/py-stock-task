...
SECRET_KEY = 'django-insecure-wugk@3yjae9itg+4*+9rzzjb^c_zyenqlq92f1*ln(s0_m6w2p'
...
ROOT_URLCONF = 'WebTaskFramework.urls'
...
WSGI_APPLICATION = 'WebTaskFramework.wsgi.application'

DATABASES = {
    'default': {
        'ENGINE': 'django.db.backends.mysql',
        'NAME': 'just_test',  # 需要提前创建
        'USER': 'user_dev',
        'PASSWORD': '302595Zjf@',
        'HOST': 'rm-2vcb4yskl6419jg47qo.mysql.cn-chengdu.rds.aliyuncs.com',
        'PORT': '3301'
    }
}
